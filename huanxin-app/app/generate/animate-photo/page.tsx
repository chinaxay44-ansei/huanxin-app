...
export default function AnimatePhotoPage() {
  ...
  const templates = [
    { id: 1, name: "动感人像", image: "/cortis-style-photo-1.jpg" },
    { id: 2, name: "街头风格", image: "/cortis-style-photo-2.jpg" },
    { id: 3, name: "艺术氛围", image: "/girl-with-goldfish-artistic-photo.jpg" },
    { id: 4, name: "赛博朋克", image: "/cyberpunk-portrait-neon.jpg" },
    { id: 5, name: "蓝调骑士", image: "/blue-knight-fantasy.jpg" },
    { id: 6, name: "蓝调天使", image: "/blue-angel-ethereal.jpg" },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-background">
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-sm border-b px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-bold">照片动起来</h1>
          <div className="w-6" />
        </div>
      </header>
