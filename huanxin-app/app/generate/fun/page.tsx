...
export default function FunPlayPage() {
  ...
  const templates = [
    { id: 1, name: "卡通头像", image: "/emoji-avatar-character.jpg" },
    { id: 2, name: "复古胶片", image: "/vintage-polaroid-photo.jpg" },
    { id: 3, name: "梦幻森林", image: "/fantasy-portrait-magic.jpg" },
    { id: 4, name: "赛博朋克", image: "/cyberpunk-portrait-neon.jpg" },
    { id: 5, name: "蓝调天使", image: "/blue-angel-ethereal.jpg" },
    { id: 6, name: "蓝调骑士", image: "/blue-knight-fantasy.jpg" },
  ]
